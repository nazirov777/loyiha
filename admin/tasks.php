...
if (isset($_POST['create_task'])) {
    ...
    // Notify Admins if teacher created it
    if ($_SESSION['role'] === 'teacher') {
        $t_name = isset($_SESSION['name']) ? $_SESSION['name'] : 'O\'qituvchi';
        notifyAdmins($pdo, "Yangi Vazifa e'lon qilindi 📝", "$t_name yangi vazifa yaratdi: $title", "tasks.php");
    }
...
$tasks = $pdo->query("
    SELECT t.*, u.name as creator_name, s.name as subject_name
    FROM tasks t 
