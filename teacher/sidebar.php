...
<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu" style="flex: 1; overflow-y: auto; padding: 0.5rem 1.5rem 2rem;">
        ...
        <a href="grades.php" title="Baholash"><i>📊</i><span>Baholash</span></a>
        <a href="mustaqil_baholash.php" title="Mustaqil Baholari"><i>🔄</i><span>Mustaqil Baholari</span></a>
        <a href="schedule.php" title="Dars Jadvali"><i>📅</i><span>Dars Jadvali</span></a>
        <a href="tasks.php" title="Vazifalar"><i>📝</i><span>Vazifalar</span></a>
        <a href="submissions.php" title="O'quvchi Topshiriqlari"><i>📥</i><span>O'quvchi Topshiriqlari</span></a>
